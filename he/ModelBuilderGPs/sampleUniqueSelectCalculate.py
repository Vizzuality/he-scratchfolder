...
def sampleUniqueSelectCalculate(
    crf_name="mammals_for_greta_Subset_Subset_galcia.crf",
    geometry="unique_square",
    unique_id_field="unique",
    output_table="C:\\Users\\Viz1\\Documents\\ArcGIS\\Projects\\SuperSample\\SuperSample.gdb\\Sample_mammals_gal6_TableSel"
):  # sampleUniqueSelectCalculate
    ...
    arcpy.conversion.PolygonToRaster(
        ...
        priority_field="NONE",
        cellsize=
        "C:\\Users\\Viz1\\Documents\\ArcGIS\\Projects\\mammal_data_cube\\mammals_for_greta_Subset.crf"
    )
    ...
    if area_value and custom_raster and table_in:
        output_table = arcpy.management.CalculateField(
            ...
            expression=f"round((!presence!/{area_value})*100,2)",
