...
def SampleBirds(crf_name="birds.crf", geometry="unique_square", output_table="C:\\Users\\Viz1\\Documents\\ArcGIS\\Projects\\SuperSample\\SuperSample.gdb\\Sample_birds1_TableSelect"):  # SampleBirds
    ...
    arcpy.conversion.PolygonToRaster(in_features=geometry, value_field="OBJECTID", out_rasterdataset=custom_raster, cell_assignment="CELL_CENTER", priority_field="NONE", cellsize="C:\\Users\\Viz1\\Documents\\ArcGIS\\Projects\\SuperSample\\birds_Subset.crf")
    ...
    if area_value and custom_raster and table_in:
        output_table = arcpy.management.CalculateField(in_table=select_table, field="percentage_presence", expression=f"round((!birds!/{area_value})*100,2)", expression_type="PYTHON3", code_block="", field_type="TEXT")[0]
